...
module.exports = async (req, res) => {
  ...
  const result = await secondCategoryManager.create(req.body)
  if (result) {
 ...
 *     tags:
 *       - Second Category
 *     description: Crea una nueva categoría de segundo nivel. El nombre de la categoría es obligatorio, y el estado activo es opcional.
 *     security:
 *       - BearerAuth: []
 *     requestBody:
 *       required: true
