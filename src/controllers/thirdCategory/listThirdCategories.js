...
module.exports = async (req, res) => {
  ...
  const result = await thirdCategoryManager.list(req.query)
  if (result) {
 ...
 *     tags:
 *       - Third Category
 *     description: Devuelve una lista de las categorías de tercer nivel con opción de búsqueda y ordenación.
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - name: search
