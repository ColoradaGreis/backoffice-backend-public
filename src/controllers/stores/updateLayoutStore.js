...
module.exports = async function (req, res, next) {
  ...
  const result = await storeManager.updateLayoutStore(req.params, req.body)
  if (result) {
...
/**
 * @openapi
 * /store/{storeId}/layouts/{layoutId}:
 *   post:
 *     tags: [Store]
 *     description: Actualiza el diseño de una tienda específica, creando un diseño de transición y guardando información de fechas y productos en la base de datos.
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - in: header
 ...
 *           example: 67890
 *     requestBody:
 *       description: Datos necesarios para actualizar el diseño de la tienda.
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 ...
 *     responses:
 *       200:
 *         description: Actualización exitosa del layouts de la tienda.
 *         content:
 *           application/json:
 *             example:
 *               successful: true
