...
module.exports = async (req, res) => {
  ...
  const result = await firstCategoryManager.list(req.query)
  if (result) {
 ...
 *     tags:
 *       - First Category
 *     description: Devuelve una lista de las categorías de primer nivel con opción de búsqueda y ordenación.
 *     security:
 *       - BearerAuth: []
 *     parameters:
 *       - name: search
